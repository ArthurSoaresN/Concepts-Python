...
# não armazenam todos os seus valores na memória. São definidos usando funções regulares, 
# mas não returna valores usando "return" utilizam "yield"

# Caracteristicas

# Uma vez que um item gerado é consumido, ele é esquecido e não pode ser acessado de novo
